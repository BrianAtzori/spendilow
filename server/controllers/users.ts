...
const loginUser = async (req: Request, res: Response) => {
    ...
    res.status(StatusCodes.OK)
        .cookie('spendilow-refresh-token', refreshToken, { httpOnly: true, maxAge: 518400000, domain: "https://spendilow.netlify.app", sameSite:'none', secure:true })
        .cookie('spendilow-access-token', accessToken, { httpOnly: true, maxAge: 21600000, domain: "https://spendilow.netlify.app",sameSite:'none', secure:true }).
