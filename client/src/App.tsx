...
function App() {
  ...
  const menuBudgetShowing: boolean = useAppSelector((state) => state.budgetMenuModal.isShowing);
      ...
      <div className='min-h-screen min-w-screen'>
        <Routes>
          ...
          <Route
            ...
            element={
              <>
                <ErrorScreenComponent message={'Pagina non trovata'}></ErrorScreenComponent>
                <Link to='/'>
