        ...
        <div className='card shrink-0 w-full max-w-sm shadow-2xl bg-base-100 font-heading text-neutral'>
          <form className='card-body'>
            <div className='text-neutral'>
              <div className='text-center'>
                ...
                <p className='pt-6 font-body text-neutral'>
                  Monitora le spese, pianifica il futuro e raggiungi i tuoi obiettivi finanziari con
                  facilità. <br></br>
            ...
            <div className='form-control mt-6'>
              <Link to='/auth/login' className='btn btn-accent font-primary font-bold text-neutral'>
                Accedi
              </Link>
              <div className='form-control mt-6'>
                <Link
