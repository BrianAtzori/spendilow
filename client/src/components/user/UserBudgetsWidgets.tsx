        ...
        <div className='text-left shadow card card-body bg-base-100 tablet:w-full'>
          ...
          <div className='flex flex-col gap-10 desktop:flex-row align-middle'>
            <div className='font-body flex flex-col gap-3 '>
              <p className=''>
                In questa scheda potrai trovare i tuoi budget, ovvero un gruppo di transazioni a cui
                dovresti assegnare un
                <strong> "obiettivo"</strong>, ad esempio comprare l'auto oppure un viaggio ✈️
              </p>
              ...
              <ul className='list-disc flex flex-col gap-3'>
                ...
                <li>
                  ...
                  durante la creazione di una transazione potrai
                  <strong> aggiungere quella transazione a un budget</strong>, tramite l'apposito
                  selettore
                </li>
              </ul>
            </div>
