...
export default function MFAComponent() {
  ...
  async function generateQR() {
    const externalCallResult: string = await activateMFA();
        ...
        <div className='card shrink-0 w-full max-w-sm shadow-2xl bg-base-100'>
          <form className='card-body font-body'>
            ...
            <div role='alert' className='alert alert-warning form-control'>
              <span>
                Una volta iniziata la procedura è necessario completare l'attivazione su Google
                Authenticator altrimenti il tuo account rimarrà bloccato.
              </span>
            </div>
