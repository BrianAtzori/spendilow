            ...
            {userTransactions.map((transaction: SpendilowTransaction) => {
              return (
                <tr key={nextId()} className='font-body'>
                  ...
                  <td>{transactionTypeIconCreator(transaction.transaction_type)}</td>
                  <td className='font-bold'>
                    {transaction.title}{' '}
                    {transaction.transaction_type === 'Budget' && transaction.target_id === null
                      ? '(Senza budget)'
                      : ''}
                  </td>
                  <td className='hidden tablet:table-cell '>{transaction.amount}</td>
